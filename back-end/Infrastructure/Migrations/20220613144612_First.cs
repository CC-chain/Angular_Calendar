        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateUser = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    CreateDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ModifyUser = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    ModifyDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Components_Sites_SiteId",
                        column: x => x.SiteId,
                        principalTable: "Sites",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SiteImages_Images_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SiteOfTimes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SiteOfTimes_Sites_SiteId",
                        column: x => x.SiteId,
                        principalTable: "Sites",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakAfter = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    BreakAfterDuration = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Color = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BeforeStart = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    AfterEnd = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Editable = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Deletable = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Draggable = table.Column<bool>(type: "tinyint(1)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservations_SiteServices_SiteServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SiteServiceDays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SiteServiceDays_SiteServices_SiteServiceId",
                        column: x => x.SiteServiceId,
                        principalTable: "SiteServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_SiteServiceId",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SiteOfTimes_SiteId",
                table: "SiteOfTimes",
                column: "SiteId");

            migrationBuilder.CreateIndex(
                name: "IX_SiteServiceDays_SiteServiceId",
                table: "SiteServiceDays",
                column: "SiteServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_SiteServices_SiteId",
                table: "SiteServices",
                column: "SiteId");
        }
